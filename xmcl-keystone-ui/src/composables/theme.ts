...
export function getDefaultTheme(): UIThemeDataV1 {
  return {
    ...
    colors: {
      ...
      darkAppBarColor: '#0f172cff',
      darkSideBarColor: '#0e172dcc',
      darkPrimaryColor: '#6f8cff',
      darkBackground: '#070c16d4',
      darkInfoColor: '#7aa9ff',
      darkErrorColor: '#ff6b92',
      darkWarningColor: '#ffb85a',

      darkSuccessColor: '#4bd9cf',
      darkAccentColor: '#9ca4ff',
      darkCardColor: '#0f172fdd',
